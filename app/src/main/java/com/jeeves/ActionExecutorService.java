...
import com.jeeves.actions.IfControl;
import com.jeeves.actions.WaitingAction;
...
import static com.jeeves.actions.ActionUtils.ACTIONS;
...
public class ActionExecutorService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        Log.i("EXECUTION", "gonna execute some com.jeeves.actions now");
