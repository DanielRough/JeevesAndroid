...
import static com.jeevesandroid.ApplicationContext.DEADLINE;
...
import static com.jeevesandroid.ApplicationContext.MISSED_SURVEYS;
import static com.jeevesandroid.ApplicationContext.NOTIF_ID;
...
import static com.jeevesandroid.ApplicationContext.WAS_INIT;
...
public class SurveyAction extends FirebaseAction {
    ...
    public static class MissedSurveyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            intended.putExtra(SURVEY_ID, intent.getStringExtra(SURVEY_ID));
            ...
            FirebaseUtils.SURVEY_REF.child(intent.getStringExtra(SURVEY_ID)).child("missed").push().setValue(surveymap);
        }
    }
