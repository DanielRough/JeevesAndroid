package com.jeevesandroid.sensing.heartrate;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            public void run() {
                while (progressStatus < 30) {
                    if(paused == false) {
                        ...
                        handler.post(new Runnable() {
                            public void run() {
                                mTextField.setText((30 - progressStatus) + " seconds left");
                            }
                        });
                    }
                    else{
                        handler.post(new Runnable() {
                            public void run() {
                                mTextField.setText("Finger not detected. Please try again");
                            }
                        });
                    }
                    try {
                ...
                returnIntent.putExtra("result",beatsAvg);
...
//            Toast.makeText(theContext,"NOPE THAT'S NOT ON",Toast.LENGTH_SHORT).show();
    ...
    private static SurfaceHolder.Callback surfaceCallback = new SurfaceHolder.Callback() {
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            try {
                ...
                Log.e("PreviewDeceCallback", "Exception in setPreviewDisplay()", t);
            }
        }
