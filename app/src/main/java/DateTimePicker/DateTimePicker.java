...
//			inflater.inflate(R.layout.datetimepicker, this, true);
			...
			myPickerView = inflator.inflate(R.layout.date_time_picker, null);
		...
		private void initializeReference() {
			...
			month_display.addTextChangedListener(month_watcher);
		...
		TextWatcher month_watcher = new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				sendToListener();
				Log.d("Set month","Set it to " + s + " at index ");
				String monthstr = s.toString();
				for(int i = 0; i < months.length; i++)
					if(monthstr.equals(months[i])) {
						cal.set(Calendar.MONTH, i);
						Log.d("Set month","Set it to " + s + " at index " + i);
					}
			}
		};
		...
		public void setYear(String year){ year_display.setText(year);}
	public void setDay(String day){ date_display.setText(day);}
	public void setHour(String hour){ hour_display.setText(hour);}
	public void setMinute(String minute){ min_display.setText(minute);}
	public void setMonth(String month){ month_display.setText(month);Log.d("Should've set","Month to " + month);}
		...
		TextWatcher date_watcher = new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				...
				try {
					...
					// TODO Auto-generated catch block
					Log.d("ERROR","NUMBER FORMAT");;
					e.printStackTrace();
				} catch (Exception e) {
					Log.d("ERROR","something else...");;
